   ...
   <div class="header2">
    ...
    <div class="container-fluide mt-3">
        <div class="row">
            ...
            <a href="insert_cat.php" class="list-group-item list-group-item-action active">INSERT_CATEGORY</a>
               ...
               <div class="card">
                   <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="" class="m-0 p-0">cat_title</label>
                        <input type="text" class="form-control" name="cat_title">
                    </div>
                    <div class="form-group">
                        <label for="" class="m-0 p-0">icon</label>
