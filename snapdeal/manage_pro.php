   ...
   <div class="header2">
    ...
    <div class="container-fluide mt-3">
        <div class="row">
            ...
            <a href="manage_pro.php" class="list-group-item list-group-item-action active">MANAGE_PRODUCT</a>
                   ...
                   <table class="table table-hover table-striped">
                       ...
                       ?>
                           <tr>
                               ...
                               <td><?= $row['qty'];?></td>
                               <td>
                                    <a href="delete.php" class="btn btn-danger btn-sm">X</a>       
