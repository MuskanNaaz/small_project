   ...
   <div class="header2">
    ...
    <div class="container-fluide mt-3">
        <div class="row">
            ...
            <a href="manage_cat.php" class="list-group-item list-group-item-action active">MANAGE_CATEGORY</a>
            ...
            <div class="col-lg-6">
               <div class="card">
                   ...
                   <table class="table table-hover table-striped">
                        ...
                        <?php
                $insert_cat = calling_data('insert_cat');
                foreach($insert_cat as $cal){
                    ?>
                        <tr>
                            <td>
                                <?= $cal['id'];?>
                            ...
                            <td>
                                <div class='btn-group'>
                                    <a href='delete.php' class='btn btn-danger'>X</a>
